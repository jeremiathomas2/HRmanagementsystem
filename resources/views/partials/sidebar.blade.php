...
<aside id="sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen shadow-lg transform transition-transform duration-300 ease-in-out translate-x-0 overflow-y-auto" style="background-color: #070029;">
    ...
    <nav class="mt-4 sm:mt-5 px-2">
        <!-- Dashboard -->
        <div class="mb-2">
            <a href="{{ route('dashboard') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('dashboard') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
        ...
        <!-- Other Menu Items -->
        <a href="{{ route('discipline') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('discipline') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
        ...
        <a href="{{ route('compliance') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('compliance') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path>
            </svg>
        ...
        <a href="{{ route('attendance') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('attendance') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
        ...
        <a href="{{ route('leave') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('leave') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
        ...
        <a href="{{ route('recruitment') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('recruitment') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"></path>
            </svg>
        ...
        <a href="{{ route('performance') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('performance') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
            </svg>
        ...
        <a href="{{ route('training') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('training') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
        ...
        <a href="{{ route('system') }}" class="group flex items-center px-2 py-2.5 text-sm font-medium rounded-md hover:bg-gray-100 hover:text-gray-900 {{ request()->routeIs('system') ? 'bg-gray-100 text-gray-900' : 'text-white hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="mr-3 h-5 w-5 group-hover:stroke-gray-900" fill="none" stroke="white" viewBox="0 0 24 24">
